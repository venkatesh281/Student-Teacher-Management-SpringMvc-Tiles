...
public class StudentDao {
	...
	public int save(Student s) {
		String sql = "insert into student(RollNum,Name,Mobile,Age,std,Gender,Place,DateOfBirth,TeacherId) values('"
				+ s.getRollnum() + "','" + s.getName() + "','" + s.getMobile() + "','" + s.getAge() + "','" + s.getStd()
				+ "','" + s.getGender() + "','" + s.getPlace() + "','" + s.getDob() + "','" + s.getTeacherId() + "')";
	...
	public int update(Student s) {
		String sql = "update student set Name='" + s.getName() + "', Mobile='" + s.getMobile() + "',Age='" + s.getAge()
				+ "',std='" + s.getStd() + "',Gender='" + s.getGender() + "',Place='" + s.getPlace()
				+ "', DateOfBirth='" + s.getDob() + "', TeacherId='" + s.getTeacherId() + "' where RollNum="
				+ s.getRollnum() + "";
		return jdbcTemplate.update(sql);
	}
